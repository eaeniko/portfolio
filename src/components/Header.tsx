...
import { routes, display, person, about, blog, work, gallery, live, learning, content } from "@/resources";
...
const TimeDisplay: React.FC<TimeDisplayProps> = ({ timeZone, locale = "en-BR" }) => {
