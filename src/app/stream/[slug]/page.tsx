...
export default async function Project({
  ...
  let post = getPosts(["src", "app", "stream", "content"]).find((post) => post.slug === slugPath);
  ...
  return (
    <Column as="section" maxWidth="m" horizontal="center" gap="l">
      ...
      <Column maxWidth="xs" gap="16">
        <Button data-border="rounded" href="/stream" variant="tertiary" weight="default" size="s" prefixIcon="chevronLeft">
          Content
        </Button>
