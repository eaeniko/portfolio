...
link: "/learning/first-html-website/index.html"
---

## Overview

Here is when I started learning about front-end and programming. This was my first ever website made following the online course I did
<br/><a href="https://eaeniko.vercel.app/learning/first-html-website/index.html" target="_blank">View live demo project</a>
<br/>**<a href="https://eaeniko.vercel.app/learning/first-html-website/index.html" target="_blank">View github project</a>**

<InArticleAd />

## Key Features

- **Responive**: Its a simples static website but yet with responsive layout

## Technologies Used
- **HTML5, CSS3, Javascript**: Simple and clean.
