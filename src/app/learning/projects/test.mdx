...
<>This was my first big course I did in Udemy plataform. Mixing a lot of languages such: html, css, javascript (angular), PHP, mysql and others. </><br/>
<br/>This project isnt a static project as the first one. The images, prices in the store and others things make call to the Mysql database to populate the website it self.
